export const abi = [
  ...
  {
    inputs: [],
    name: "enableConvertingReferralRewards",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "account", type: "address" }],
    name: "getConvertReferralRewards",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "account", type: "address" }],
    name: "getUnconvertedReferralRewards",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "uint256", name: "index", type: "uint256" }],
    name: "getUnconvertedReferralRewardsIndexAt",
    outputs: [
      { internalType: "address", name: "", type: "address" },
      { internalType: "uint256", name: "", type: "uint256" },
      { internalType: "uint256", name: "", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "address", name: "", type: "address" }],
    name: "referralEarningsConverted",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "address", name: "", type: "address" }],
    name: "referralEarningsConvertedInPayout",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "totalReferralsDistributedConverted",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [],
    name: "totalReferralsDistributedConvertedInPayout",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "unconvertedTokensIndexUpper",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
...
export const address = "0xb0c75Ccadb47E89fDFB917073c564686b10aB7F3";
